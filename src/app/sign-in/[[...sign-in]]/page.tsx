...
const SignInPage = () => {
  return (
    <div className="h-screen flex justify-between items-center p-8">
      ...
      <Link href={"/sign-up"} className="bg-iconBlue rounded-full  p-2 text-white font-bold text-center w-72">Create Account</Link>
        </SignIn.Root>
      </div>
    </div>
  );
